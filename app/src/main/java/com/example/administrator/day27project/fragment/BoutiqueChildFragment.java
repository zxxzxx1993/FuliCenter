...
import com.example.administrator.day27project.adapter.BoutiqueChildAdapter;
...
public class BoutiqueChildFragment extends BaseFragment {

    GridLayoutManager glm;
    BoutiqueActivity mcontext;
    BoutiqueChildAdapter mGoodsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mcontext = (BoutiqueActivity) getContext();
        mlist = new ArrayList<>();
        catId= mcontext.getIntent().getIntExtra(I.Boutique.CAT_ID, 0);
        mGoodsAdapter = new BoutiqueChildAdapter(mcontext, mlist);
    ...
    protected void initData(final int action) {
        NetDao.downloadBoutiqueChild(mcontext,catId, pageId, new OkHttpUtils.OnCompleteListener<NewGoodsBean[]>() {
            @Override
